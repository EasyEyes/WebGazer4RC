...
const createSsdAnchors = (config)=>{
  ...
  export const useFullRangeModel = (model) =>{
    ...
    model.detector.tensorsToDetectionConfig = FULL_RANGE_TENSORS_TO_DETECTION_CONFIG;
    ...
    model.detector.anchorTensor = { x: anchorX, y: anchorY, w: anchorW, h: anchorH };
  }